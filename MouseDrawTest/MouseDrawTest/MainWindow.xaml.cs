...
namespace MouseDrawTest
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            drawing = true;
            currentPoint = e.GetPosition(this); pointCollection.Add(currentPoint);
        }
        ...
        {
            if (drawing && lineCollection.Count > 1) 
            {
                //DouglasPeuckerReduction(pointCollection, 2)
                Path path = MakeCurve(DouglasPeuckerReduction(pointCollection, 0.4).ToArray(), 1.2);
